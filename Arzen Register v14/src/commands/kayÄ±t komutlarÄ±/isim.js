...
run: async (client, message, args, embed, prefix) => { 
    ...
    {
    message.react(red)
    message.lineReply(`\`${prefix}isim <@Üye/ID> <Isim> <Yaş>\``).then(x=>x.delete({timeout:5000})) 
    return }
...
.setFooter(`Üyenin önceki isimlerine <!isimler @Üye/ID> komutuyla bakarak kayıt işlemini gerçekleştirmeniz önerilir.`))
